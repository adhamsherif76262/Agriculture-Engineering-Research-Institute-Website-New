...
var Current_President_Section = document.getElementById("Current_President_Section");
...
function Home_Load_Content_Ar() {
  ...
  Second_P.textContent = "باختصار، الهندسة الزراعية تسهم بفاعلية في تعزيز الزراعة المستدامة وزيادة كفاءة وإنتاجية العمليات الزراعية من خلال الابتكار والتكنولوجيا المتقدمة.";
...
function Home_Load_Content_En() {
  ...
  Second_P.textContent = "In summary, agricultural engineering actively contributes to promoting sustainable agriculture and increasing the efficiency and productivity of agricultural operations through innovation and advanced technology.";
